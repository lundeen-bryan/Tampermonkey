          ...
          CS({
            ...
            o: function (dat) {
              ...
              var mainPg = /\/search\?|&q=|#q=/.test(lh),
                ...
                isWHShown =
                  imgTools && /[&?]tbs[^&]*?(=|,|%2C)imgo(:|%3A)1/i.exec(lh), // sizes are shown if images
                buttSearcStart =
                  startPg &&
                  layout1811 &&
                  ($q('input[name="btnK"]') ||
                    $('input[aria-label="Google Search"]')), //for the start page
                buttSearch =
              ...
              if (buttSearch && !layout1811 && buttSearch.parentNode) {
              ...
              if (buttSearch && top == self)
                for (var i in buttS)
                  if (i != "site" || S.sites) {
                    //buttons under search input line
                    if (i.length == 2) iD++;
                    else iD = -1;
                    var bI = buttS[i],
                        ...
                        at: {
                          ...
                          innerHTML:
                            ...
                            (lang || i == "site" || i == ".. : .."
                              ? (iD == -1 || S.dwmyh[iD] == 1
                                  ? bI.txt
                                  : $L["past"][1] + " " + hint(S.dwmyh[iD] - 1)
                                ).replace(/letzte/, Gesch)
                              : "") +
                            '" itrvNum="' +
                            (i == "site" ? "" : bI.url + S.dwmyh[iD]) +
                            '">' +
                            (iD != -1 && S.dwmyh[iD] != 1
                              ? S.dwmyh[iD] + bI.lett
                              : imgSrch && i == "PDF"
                          ...
                          click: (function (bI, i, iD) {
                            ...
                            return /Srch|PDF|DOC|site/.test(i)
                              ? function (ev) {
                                  var t = ev.target;
                                  console.log(
                                    "cli-DocSite: i,t.class,value,ev,attrSite,$LS,aPSite,bSSta",
                                    i,
                                    t.className,
                                    inputSearch.value,
                                    ev,
                                  ...
                                  if (imgSrch && i == "PDF") {
                                    ...
                                    location.href = isWHShown
                                      ...
                                      : lh +
                                        (/\?/.test(lh) ? "&" : "?") +
                                        "tbs=imgo:1"; //new Tools-More_tools_Show_sizes
                                  } else if (
                                    (t &&
                              ...
                              : function (ev) {
                                  ...
                                  console.log(
                                    "cli-Past: value,date2,siteList,list,l2",
                                    inputSearch.value,
                                    date2,
                                  ...
                                  (sI != $LSettings && !(!S.sites && i == "1H")
                                    ...
                                    : '<div class="settIn">' +
                                      ...
                                      S.whiteMintOval === undefined
                                        ...
                                        : "") +
                                      "/>" +
                                      '<label for="design1612" id="design1612L">' +
                                    ...
                                    var l2 = startPg
                                      ...
                                      newSrch = /[?&]q=/.test(l2)
                                        ...
                                        : l2 +
                                          ...
                                          encodeURIComponent(inputSearch.value); //set new value as &q=.+
                                    console.log(
                                      "==inputSearch.value,newSrch,fTyp,pdf,num",
                                      inputSearch.value,
                                      newSrch,
                                      fTyp,
                                      pdf,
